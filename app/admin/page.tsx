          ...
          <div className="rounded-3xl border border-purple-800 bg-[#0f0a14] p-8 shadow-lg">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
                ...
                <label className="flex h-64 w-44 cursor-pointer items-center justify-center overflow-hidden rounded-2xl border-2 border-dashed border-purple-700 bg-[#18101f] transition hover:border-pink-400 hover:bg-[#24152f]">
