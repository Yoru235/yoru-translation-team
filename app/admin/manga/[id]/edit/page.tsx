...
export default function EditMangaPage() {
  ...
  const [translationGroups, setTranslationGroups] =
  useState<TranslationGroup[]>([]);

const [translationGroupId, setTranslationGroupId] =
  useState("");
  // ==========================================
...
<div>
  ...
  <p className="mt-2 text-xs text-gray-600">
    Chọn nhóm dịch đang phụ trách bộ truyện này.
  </p>
</div>
            {/* LOẠI + TRẠNG THÁI */}
