...
export async function generateMetadata({
  ...
  if (!manga) {
    return {
      title: "Không tìm thấy truyện - Yoru Translation Group",
    };
  }

  const title = `${manga.title} - Đọc Truyện ${manga.type} | Yoru Translation Group`;
  const description =
    manga.description ||
    `Đọc truyện ${manga.title} mới nhất tại Yoru Translation Group.`;
