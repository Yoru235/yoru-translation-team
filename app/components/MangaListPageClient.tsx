    ...
    <main className="min-h-screen bg-black text-white">
        ...
        <div className="mx-auto flex min-h-16 max-w-6xl items-center justify-between px-4">
          <a href="/" className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <p className="font-extrabold">Yoru Translation Group</p>
      ...
      <section className="border-b border-gray-900 bg-[#080808]">
        <div className="mx-auto max-w-6xl px-4 py-8">
          <h1 className="text-3xl font-extrabold">Danh sách truyện</h1>
              ...
              {mangas.map((manga) => (
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <p className="mt-1 text-xs text-purple-400">{manga.type}</p>
                  </div>
                </a>
              ))}
            </div>
